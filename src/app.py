...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and weekend matches to build fitness and teamwork",
        "schedule": "Tuesdays and Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 18,
        "participants": ["natalie@mergington.edu", "leo@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Competitive drills and friendly games for all skill levels",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, create performances, and build stage confidence",
        "schedule": "Tuesdays and Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["mia@mergington.edu", "jack@mergington.edu"]
    },
    "Science Explorers": {
        "description": "Hands-on experiments and science projects for curious minds",
